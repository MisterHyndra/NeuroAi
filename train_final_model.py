"""
Treinamento FINAL - Modelo equilibrado sem viés
"""
import os
import numpy as np
import cv2
...
def load_balanced_data(dataset_path, max_per_category=300):
...
def create_optimal_model(input_shape):
    """Cria modelo otimizado para detecção equilibrada"""
    ...
    model = Sequential([
        ...
        # Bloco 2 - Detecção de padrões
        Conv2D(64, (3, 3), activation='relu', kernel_regularizer=l2(0.001)),
        BatchNormalization(),
        MaxPooling2D(2, 2),
        Dropout(0.25),
        
        # Bloco 3 - Detecção de características complexas
        Conv2D(128, (3, 3), activation='relu', kernel_regularizer=l2(0.001)),
        BatchNormalization(),
        MaxPooling2D(2, 2),
        Dropout(0.25),
        
        # Bloco 4 - Detecção de padrões finos
...
def main():
    """Função principal para treinamento final"""
    
    print("🔧 TREINAMENTO FINAL - Modelo Equilibrado")
    print("=" * 60)
    ...
    try:
        ...
        X, y = load_balanced_data(dataset_path, max_per_category=300)
        ...
        # Treinamento
        print(f"\n🚀 Iniciando treinamento final (20 épocas)...")
        ...
        if not is_balanced:
            ...
            new_bias = current_bias - 0.2  # Ajustar para ser mais neutro
        ...
        model.save('models/brain_cancer_final.h5')
        print(f"\n💾 Modelo final salvo: models/brain_cancer_final.h5")
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig('results/final_training_history.png', dpi=300)
            print(f"📈 Gráficos salvos: results/final_training_history.png")
        ...
        print(f"1. Teste o novo modelo: models/brain_cancer_final.h5")
